          ...
          <div className="w-full max-w-md">
            ...
            <div className="mt-8">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 py-3 font-mono text-sm uppercase tracking-widest transition-all disabled:opacity-50"
                style={{
                  border: "1px solid var(--portal-border)",
                  color: "var(--portal-text)",
                  background: "transparent",
                }}
                onMouseEnter={e => (e.currentTarget.style.borderColor = "var(--portal-accent)")}
